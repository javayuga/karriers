package club.code55.repository;

import club.code55.WebuiApp;
import club.code55.config.Constants;
import club.code55.config.audit.AuditEventConverter;
import club.code55.domain.PersistentAuditEvent;
...
import static club.code55.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
