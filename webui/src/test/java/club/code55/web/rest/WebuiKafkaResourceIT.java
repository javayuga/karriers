...
class WebuiKafkaResourceIT {
    ...
    void setup() {
        ...
        WebuiKafkaResource kafkaResource = new WebuiKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/webui-kafka/publish/topic-produce?message=value-produce"))
